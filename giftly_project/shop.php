...
<div class="container" style="padding-top: 130px;">
   ...
   <div class="product-grid">
    ...
    $sql .= " ORDER BY CASE WHEN quantity > 0 THEN 0 ELSE 1 END, id ASC";
        ...
        while($row = $result->fetch_assoc()) {
            ...
            <div class="'.$cardClass.'" onclick="'.$onClick.'">
                ...
                <div class="p-image-container">
                    ...
                    <!-- 🚀 OUT OF STOCK OVERLAY (Shows on hover) -->
                    ' . (!$isInStock ? '
                    ...
                    <button class="p-image-heart"><i class="far fa-heart"></i></button>
                </div>
                
                <div class="p-name">'.$row['name'].'</div>
                
                <div class="p-bottom-row">
                    <div class="p-price">PHP <span>'.number_format($row['price'], 2).'</span></div>
