...
<div class="cart-wrapper">
    ...
    <div class="cart-left">
        ...
        <div class="cart-top-row">
            ...
            <div class="top-actions">
                <button class="top-action-btn" onclick="alert('Wishlist feature coming soon! 🌸')">
    ...
    <?php
    $sql = "SELECT c.id as cart_id, c.quantity, p.name, p.price, p.image, p.quantity as stock_quantity FROM carts c JOIN products p ON c.product_id = p.id WHERE c.user_id = $user_id";
    ...
    if ($result->num_rows > 0) {
        // First pass: collect all items and separate by stock availability
        ...
        foreach($in_stock_items as $row) {
            ...
            <div class="cart-item-card" id="row_<?php echo $row['cart_id']; ?>" data-stock="<?php echo $row['stock_quantity']; ?>">
                ...
                <div class="ci-details">
                    ...
                    <!-- Restored: "Stock: X available" text -->
