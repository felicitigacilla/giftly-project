...
if (($origin !== '' && in_array($origin, $allowedOrigins, true)) || preg_match('/^https?:\/\/localhost:\d+$/', $origin) === 1 || preg_match('/^https?:\/\/127\.0\.0\.1:\d+$/', $origin) === 1 || preg_match('/^https?:\/\/.*\.onrender\.com$/', $origin) === 1) {
