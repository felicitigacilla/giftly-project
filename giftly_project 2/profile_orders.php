...
if (isset($_GET['cancel_order'])) {
    ...
    $api_url = 'http://localhost/giftly_project/api/index.php?route=orders/cancel&id=' . $order_id;
    $options = [
        'http' => [
            'method' => 'PUT',
...
// --- FETCH ALL ORDERS WITH API FALLBACK ---
$orders = [];
$use_api = false;

// Try API first
$api_url = 'http://localhost/giftly_project/api/index.php?route=orders';
...
// If API failed, use direct database
if (!$use_api) {
