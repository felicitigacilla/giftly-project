    ...
    <div class="carousel-wrapper">
        <div class="carousel-container">
            ...
            <div class="slide slide-2">
                <div class="slide-text" style="flex: 0.9;">
                    <h1>Explore Curated <span>Collections</span><br>for Every Occasion</h1>
                    <p>Discover beautifully packaged gifts for birthdays, anniversaries, and holidays.</p>
                    <div class="hero-buttons">
                        <a href="shop.php" class="btn-primary" style="padding: 14px 35px; text-decoration:none; display:inline-block;">Shop Collection</a>
                        <a href="shop.php" class="btn-secondary" style="padding: 14px 35px; text-decoration:none; display:inline-block;">Explore Gifts</a>
                    </div>
                </div>
                
                <div class="slide-graphic" style="flex: 0.8; height: 90%; border-radius: 20px; background-image: url('https://images.unsplash.com/photo-1513201099705-a9746e1e201f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'); background-size: cover; background-position: center;"></div>
            </div>

            <!-- SLIDE 3: Bundles -->
            <div class="slide slide-3">
                <div class="slide-text" style="flex: 0.9;">
                    <h1>Save Big with <span>Exclusive Bundles</span><br>Today</h1>
                    <p>Get premium gift sets at discounted prices. Perfect for sharing love and joy.</p>
                    <div class="hero-buttons">
                        <a href="shop.php" class="btn-primary" style="padding: 14px 35px; text-decoration:none; display:inline-block;">View Bundles</a>
                        <a href="shop.php" class="btn-secondary" style="padding: 14px 35px; text-decoration:none; display:inline-block;">Start Shopping</a>
                    </div>
                </div>
                
                <div class="slide-graphic" style="flex: 0.8; height: 90%; border-radius: 20px; background-image: url('https://images.unsplash.com/photo-1519340241574-2cec6aef0c01?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'); background-size: cover; background-position: center;"></div>
            </div>
